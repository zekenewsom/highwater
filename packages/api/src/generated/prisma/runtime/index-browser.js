  ...
  we = class {
    constructor(n) {
      n === ie
        ...
        : me.set(
            this,
            'new Prisma.'.concat(this._getNamespace(), '.').concat(this._getName(), '()'),
          );
    }
    _getName() {
...
h.cubeRoot = h.cbrt = function () {
  ...
  for (
    w = !1,
      ...
      !s || Math.abs(s) == 1 / 0
        ? ((i = b(l.d)),
          ...
          s == 1 / 0
            ? (i = '5e' + e)
            : ((i = s.toExponential()), (i = i.slice(0, i.indexOf('e') + 1) + e)),
          (t = new a(i)),
          (t.s = l.s))
        : (t = new a(s.toString())),
      o = (e = a.precision) + 3;
    ...
    if (
      ...
      (c = u.times(u).times(u)),
      (f = c.plus(l)),
      (t = k(f.plus(l).times(u), f.plus(c), o + 2, 1)),
      ...
      if (((i = i.slice(o - 3, o + 1)), i == '9999' || (!r && i == '4999'))) {
        ...
        (!+i || (!+i.slice(1) && i.charAt(0) == '5')) &&
          (p(t, e + 1, 1), (n = !t.times(t).times(t).eq(l)));
        break;
      }
  ...
  return i.isFinite()
    ? i.isZero()
      ...
      : ((e = t.precision),
        ...
        (t.precision = e + 7),
        (t.rounding = 1),
        k(i.sinh(), i.cosh(), (t.precision = e), (t.rounding = n)))
    : new t(i.s);
};
...
h.inverseTangent = h.atan = function () {
  ...
  for (w = !1, n = Math.ceil(u / m), t = 1, c = f.times(f), o = new l(f), r = f; e !== -1; )
    if (
      ((r = r.times(c)),
      (s = o.minus(r.div((t += 2)))),
      (r = r.times(c)),
...
h.minus = h.sub = function (e) {
  ...
  if (((i = R(e.e / m)), (l = R(g.e / m)), (f = f.slice()), (s = l - i), s)) {
    for (
      a = s < 0,
        a ? ((n = f), (s = -s), (o = d.length)) : ((n = d), (i = l), (o = f.length)),
...
h.plus = h.add = function (e) {
  ...
  if (((s = R(a.e / m)), (t = R(e.e / m)), (f = f.slice()), (r = s - t), r)) {
    for (
      r < 0 ? ((i = f), (r = -r), (o = l.length)) : ((i = l), (t = s), (o = f.length)),
        s = Math.ceil(u / m),
        o = s > o ? s + 1 : o + 1,
        r > o && ((r = o), (i.length = 1)),
        i.reverse();
...
h.squareRoot = h.sqrt = function () {
  ...
  for (
    w = !1,
      ...
      f == 0 || f == 1 / 0
        ? ((n = b(u)),
          ...
          f == 1 / 0
            ? (n = '5e' + c)
            : ((n = f.toExponential()), (n = n.slice(0, n.indexOf('e') + 1) + c)),
          (t = new l(n)))
        : (t = new l(f.toString())),
      i = (c = l.precision) + 3;
    ;
    ...
    if (
      ((s = t),
      (t = s.plus(k(o, s, i + 2, 1)).times(0.5)),
...
h.times = h.mul = function (e) {
  ...
  if (((e.s *= l.s), !d || !d[0] || !g || !g[0]))
    return new a(
      !e.s || (d && !d[0] && !g) || (g && !g[0] && !d) ? NaN : !d || !g ? e.s / 0 : e.s * 0,
    );
  for (
    i = R(l.e / m) + R(e.e / m),
      c = d.length,
...
h.toDecimalPlaces = h.toDP = function (e, n) {
  ...
  return (
    ...
    e === void 0
      ? i
      : (q(e, 0, H), n === void 0 ? (n = t.rounding) : q(n, 0, 8), p(i, e + i.e + 1, n))
  );
};
...
h.toFraction = function (e) {
  ...
  for (
    w = !1, u = new N(b(v)), l = N.precision, N.precision = s = v.length * m * 2;
...
h.toNearest = function (e, n) {
  ...
  return (
    e.d[0] ? ((w = !1), (i = k(i, e, 0, n, 1).times(e)), (w = !0), p(i)) : ((e.s = i.s), (i = e)), i
  );
};
h.toNumber = function () {
  return +this;
...
h.toString = function () {
  var e = this,
    n = e.constructor,
    i = L(e, e.e <= n.toExpNeg || e.e >= n.toExpPos);
    ...
    t == null
      ? n < 3
        ? (n == 0 ? (u = (u / 100) | 0) : n == 1 && (u = (u / 10) | 0),
          (o = (i < 4 && u == 99999) || (i > 3 && u == 49999) || u == 5e4 || u == 0))
        : (o =
  ...
  return function (t, r, s, o, u, c) {
    ...
    if (
      ...
      if (((I = (I / g + 2) | 0), (a = 0), T == 1)) {
        ...
        for (
          d = (c / (S[0] + 1)) | 0,
            d > 1 && ((S = e(S, d, c)), (O = e(O, d, c)), (T = S.length), (W = O.length)),
            z = T,
            E = O.slice(0, T),
            P = E.length;
          P < T;
          ...
          (d = 0),
            ...
            f < 0
              ? ((x = E[0]),
                ...
                i(E, N, P, c),
                f == -1 &&
                  ((P = E.length), (f = n(S, E, T, P)), f < 1 && (d++, i(E, T < P ? y : S, P, c))),
                (P = E.length))
              : f === 0 && (d++, (E = [0])),
            (_[a++] = d),
...
function p(e, n, i, t) {
  ...
  e: if (n != null) {
    ...
    if (
      ((t = t || n < 0 || a[d + 1] !== void 0 || (o < 0 ? l : l % C(10, r - o - 1))),
      (f =
        i < 4
          ? (c || t) && (i == 0 || i == (e.s < 0 ? 3 : 2))
          : c > 5 ||
            (c == 5 &&
              (i == 4 ||
                t ||
                (i == 6 && (s > 0 ? (o > 0 ? l / C(10, r - o) : 0) : a[d - 1]) % 10 & 1) ||
                i == (e.s < 0 ? 8 : 7)))),
      n < 1 || !a[0])
    )
      return (
        (a.length = 0),
        f ? ((n -= e.e + 1), (a[0] = C(10, (m - (n % m)) % m)), (e.e = -n || 0)) : (a[0] = e.e = 0),
        e
      );
    if (
      (s == 0
...
function be(e, n) {
  ...
  for (n == null ? ((w = !1), (c = v)) : (c = n), u = new d(0.03125); e.e > -2; )
    (e = e.times(u)), (a += 5);
  for (
...
function re(e, n) {
  ...
  if (((n = n.slice(t, r)), n)) {
    if (
      ((r -= t), (e.e = i = i - t - 1), (e.d = []), (t = (i + 1) % m), i < 0 && (t += m), t < r)
    ) {
...
function gn(e, n) {
  ...
  for (
    s = n.search(/p/i),
      s > 0 ? ((c = +n.slice(s + 1)), (n = n.substring(2, s))) : (n = n.slice(2)),
      s = n.indexOf('.'),
      o = s >= 0,
      t = e.constructor,
...
function Pe(e, n, i, t) {
  ...
  if (
    ...
    for (
      l = L(e),
        o = l.indexOf('.'),
        v ? ((r = 2), n == 16 ? (i = i * 4 - 3) : n == 8 && (i = i * 3 - 2)) : (r = n),
        o >= 0 &&
          ((l = l.replace('.', '')),
          (d = new g(1)),
          (d.e = l.length - o),
      ...
      if (
        ...
        (f =
          t < 4
            ...
            : o > u ||
              (o === u && (t === 4 || f || (t === 6 && a[i - 1] & 1) || t === (e.s < 0 ? 8 : 7)))),
        (a.length = i),
        f)
      )
...
function Ge(e) {
  ...
  if (
    ...
    for (
      t = ['precision', 'rounding', 'toExpNeg', 'toExpPos', 'maxE', 'minE', 'modulo', 'crypto'],
        n = 0;
      n < t.length;
  ...
  if ((e === void 0 ? (e = this.precision) : q(e, 1, H), (t = Math.ceil(e / m)), this.crypto))
    if (crypto.getRandomValues)
      for (n = crypto.getRandomValues(new Uint32Array(t)); s < t; )
        (r = n[s]),
          r >= 429e7 ? (n[s] = crypto.getRandomValues(new Uint32Array(1))[0]) : (u[s++] = r % 1e7);
