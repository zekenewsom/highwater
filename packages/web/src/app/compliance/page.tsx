      ...
      <main className="min-h-screen bg-gray-50 p-8">
        <div className="max-w-7xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-8">
            <a href="/crypto-onboarding" className="block">
              <div className="bg-white rounded-lg shadow p-4 hover:shadow-md transition-shadow duration-200 cursor-pointer">
                <div className="flex items-center">
                  ...
                  <div className="ml-3">
                    ...
                    <p className="text-xs text-gray-500">Complete • Click to review</p>
                  </div>
                </div>
              </div>
            </a>
